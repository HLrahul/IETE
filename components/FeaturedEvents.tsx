...
export default function FeaturedEvents() {
    return (
      <div className="h-auto md:h-[120vh] w-[100%] m-auto p-10 md:flex flex-col justify-center items-center">
        <h1 className="flex items-center justify-center text-[4rem] font-bold w-full m-auto mt-[4rem] mb-[3rem]">
          RECENT EVENTS
        </h1>
