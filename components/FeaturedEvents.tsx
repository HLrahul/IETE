...
export default function FeaturedEvents() {
    return (
        <div className="h-[150vh] w-full p-10 flex items-center justify-center">
            <div className="h-[50%] w-[100%] md:w-[70%] m-auto grid gap-5 sm:grid-rows-4 md:grid-rows-2 sm:grid-cols-1 md:grid-cols-2">
                <EventDialog
